  ...
  function createEvaluationRunner({
    ...
    function finalizeNoActionResult(item, detection) {
      ...
      const criteria = [
        ...
        criterion("notification_restraint", "No recommendation or notification was produced", !output.shouldNotify && output.recommendation === null && !output.emailSent && !output.chatRecommendationSent, "No recommendation, email, or chat notification was produced."),
