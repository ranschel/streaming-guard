...
- Evaluate the complete output. A material fact can satisfy an evidence requirement wherever it appears; do not require it to be repeated in the evidence array or labeled with a technical record or source name.
...
- Identify specific material omissions or contradictions in `gaps`; use an empty array when there are none.
